...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void cboxVeiculosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboxVeiculosActionPerformed
        long periodoPermanencia = controle.calculaPermanencia(cboxVeiculos.getSelectedItem().toString()) / (60*1000);
        if (periodoPermanencia < 60) {
            txtbPeriodoPermanencia.setText(Long.toString(periodoPermanencia) + " Minutos");
    ...
    private void cboxMetricaCalculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboxMetricaCalculoActionPerformed
        ...
        Object metricaSelectedItem = cboxMetricaCalculo.getSelectedItem();
        Object veiculoSelectedItem = cboxVeiculos.getSelectedItem();
        
        if (metricaSelectedItem != null && veiculoSelectedItem != null) {
            MetricaCalculoEnum metricaSelecionada = MetricaCalculoEnum.valueOf(metricaSelectedItem.toString());
